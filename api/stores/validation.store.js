...
class ValidationStore {
  ...
  static employmentData(data) {
    let errors = {};

    data.employer = !(this.isEmpty(data.employer)) ? data.employer : '';
    data.location = !(this.isEmpty(data.location)) ? data.location : '';
    data.reason_for_leaving = !(this.isEmpty(data.reason_for_leaving))
        ? data.reason_for_leaving
        : '';
    data.supervisor = !(this.isEmpty(data.supervisor)) ? data.supervisor : '';
    data.phone_number = !(this.isEmpty(data.phone_number))
        ? data.phone_number
        : '';
